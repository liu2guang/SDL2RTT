...
int main_testttf(int argc, char *argv[])
{
    ...
    SDL_Window* pWin = SDL_CreateWindow("Game", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 480, 272, 0);
    if (pWin == NULL) {
    ...
    // TTF_Font* font = TTF_OpenFont("/sd/lazy.ttf", 24);
    TTF_Font* font = TTF_OpenFont("/sd/SyntaxLTStd_Roman.ttf", 24);
